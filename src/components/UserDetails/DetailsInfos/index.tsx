...
export default function DetailsInfos({ links }: DetailsInfosPropos) {
  ...
  return (
    <S.Container>
      <S.Link className={`${!links.location && "unavailable"}`}>
        ...
        <S.Data>{links.location || "Não tem"}</S.Data>
      </S.Link>

      <S.Link className={`${!links.blog && "unavailable"}`}>
        {links.blog ? (
          <a href={links.blog}>
          ...
          <>
            ...
            <S.Data>Não tem</S.Data>
          </>
        )}
      </S.Link>
      <S.Link className={`${!links.twitter && "unavailable"}`}>
        {links.twitter ? (
      ...
      <S.Link className={`${!links.company && "unavailable"}`}>
        <svg height="20" width="20" xmlns="http://www.w3.org/2000/svg">
          <g fill={lightMode ? "#4b6a9b" : "#fff"}>
        ...
        <S.Data>{links.company || "Não tem"}</S.Data>
      </S.Link>
    </S.Container>
  );
}